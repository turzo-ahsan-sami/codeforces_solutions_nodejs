...
//*
function main() {
    let dominoes = readline().split(' ').map(Number)
    let squareSpace = dominoes[0] * dominoes[1]
    let squareSpace_single_domino = 2 * 1

    let domino_count = Math.floor(squareSpace / squareSpace_single_domino)

    console.log(domino_count)
}
//*/

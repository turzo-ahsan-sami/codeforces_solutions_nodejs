...
const removeAdjacentDuplicates = str => str.replace(/(.)\1*/g, '$1');
...
//*
function main() {
    let stone_count = readline()
    let stones = readline()
    stones = removeAdjacentDuplicates(stones)
    console.log(parseInt(stone_count) - stones.length)
}
//*/
